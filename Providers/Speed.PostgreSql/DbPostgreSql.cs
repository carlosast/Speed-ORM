...
#endif
    class DbNpgsqlProvider : IDbProvider
    {
        ...
        static DbNpgsqlProvider()
        {
            //Sys.LoadLibraryW("./Npgsql.Data.dll");
        }

        public DbNpgsqlProvider(Database db)
        {
            this.db = db;
        }
...
".Replace("''", "\"");
        ...
        {
            return new DbNpgsqlProvider(db);
        }

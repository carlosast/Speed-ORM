...
namespace Speed.Data
{
    ...
    class DbFirebirdProvider : IDbProvider
    {
        ...
        {
            //Sys.LoadLibraryW("./Firebird.Data.dll");
        }
        ...
        public Type DbType { get { return typeof(FirebirdDbType); } }
        ...
        public Dictionary<int, Enum> DbTypes
        {
            ...
            {
                if (dbTypes == null)
                    dbTypes = DbUtil.GetTypes<FirebirdDbType>();
                return dbTypes;
            }
        }
        ...
        //{
        //    FirebirdConnectionStringBuilder csb = new FirebirdConnectionStringBuilder();
        //    csb.Server = server;
        ...
        {
            FirebirdConnectionStringBuilder csb = new FirebirdConnectionStringBuilder(connectionString);
            return csb;
        }
        ...
        {
            var csb = new FirebirdConnectionStringBuilder();
            csb.Server = server;
            csb.Database = database;
        ...
        {
            FirebirdConnection cn = new FirebirdConnection(connectionString);
            cn.Open();
        ...
        {
            FirebirdParameter par = new FirebirdParameter(parameterName, value);
            par.DbType = dbType;
            par.Value = value;
        ...
        {
            FirebirdParameter par = new FirebirdParameter(parameterName, FirebirdDbType.Binary);
...
select TABLE_CATALOG, TABLE_SCHEMA, TABLE_NAME,          TABLE_TYPE from information_schema.TABLES where table_schema = {0}";
        ...
        public IDbDataParameter Convert(Parameter parameter)
        {
            ...
            return new FirebirdParameter(parameter.Name, parameter.Value);
        }
        ...
        {
            return ((FirebirdDataReader)reader).GetTimeSpan(ordinal);
        }

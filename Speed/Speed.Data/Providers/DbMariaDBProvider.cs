...
#endif
    class DbMariaDBProvider : IDbProvider
    {
        ...
        public DbMariaDBProvider(Database db)
        {
            this.db = db;
        }
        ...
        {
            return BuildConnectionString(EnumDbProviderType.MariaDB, server, database, userId, password, integratedSecurity, port, embedded);
        }

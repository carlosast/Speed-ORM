...
namespace Speed.Windows
{
    ...
    public class InputBox
    {
        ...
        private static bool isPassword = false;
        ...
        static public InputBoxResult Show(string Prompt, bool isPassword = false)
        {
            InitializeComponent();
            FormPrompt = Prompt;
        ...
        static public InputBoxResult Show(string Prompt, string Title, bool isPassword = false)
        {
            InitializeComponent();
        ...
        static public InputBoxResult Show(string Prompt, string Title, string Default, bool isPassword = false)
        {
            InitializeComponent();
        ...
        static public InputBoxResult Show(string Prompt, string Title, string Default, int XPos, int YPos, bool isPassword = false)
        {
            InitializeComponent();
            FormCaption = Title;
            FormPrompt = Prompt;

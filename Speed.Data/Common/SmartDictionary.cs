...
namespace Speed.Common
{
    ...
    public class SmartDictionary<TKey, TValue> : Dictionary<TKey, TValue>
    {
        ...
        Func<TValue> funcFindValue;

        public SmartDictionary()
        {
        }

        public SmartDictionary(Func<TValue> funcFindValue)
        {
            this.funcFindValue = funcFindValue;
        }
    ...
    public class SmartDictionaryList<TKey, TValue> : Dictionary<TKey, List<TValue>>
    {
        ...
        Func<IEnumerable<TValue>> funcFindValue;

        public SmartDictionaryList()
        {
        }

        public SmartDictionaryList(Func<IEnumerable<TValue>> funcFindValue)
        {
            this.funcFindValue = funcFindValue;
        }

...
namespace Speed.Common
{
    ...
    public static class CollectionUtil
    {
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        public static TSource GetValue<TKey, TSource>(this ConcurrentDictionary<TKey, TSource> source, TKey key)
        {
            TSource ret;
            if (source.TryGetValue(key, out ret))
                return ret;
        ...
        public static ConcurrentDictionary<TKey, List<TSource>> ToConcurrentDictionary<TKey, TSource>(this IEnumerable<TSource> source, Func<TSource, TKey> keySelector, IEqualityComparer<TKey> comparer = null)
        {
            ...
            return new ConcurrentDictionary<TKey, List<TSource>>(dic);
        }

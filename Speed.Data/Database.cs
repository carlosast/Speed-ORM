...
namespace Speed.Data
{
    ...
    public class Database : Object, IDisposable
    {
        ...
        */
        ...
        {
            return ProviderFactory.CreateProvider(db, providerType);
        }
        ...
        public long Count<T>(T filter, EnumDbFilter mode = EnumDbFilter.AndLike, int commandTimeout = 30)
        {
            DataClass dc = getCache<T>();
        ...
        public List<T> Select<T>(Database db, object filter, EnumDbFilter mode = EnumDbFilter.AndLike, bool concurrency = false, int commandTimeout = 30)
        {
            DataClass dc = getCache<T>();
        ...
        public List<T> SelectPage<T>(T filter, int start, int pageSize = 20, string sort = null, EnumDbFilter mode = EnumDbFilter.AndLike, int commandTimeout = 30, bool concurrency = false, params Parameter[] parameters)
        {
            DataClass dc = getCache<T>();
        ...
        public T SelectSingle<T>(Database db, object filter, EnumDbFilter mode = EnumDbFilter.AndLike, bool concurrency = false, int commandTimeout = 30)
        {
            DataClass dc = getCache<T>();
        ...
        */
        ...
        public DictionarySchemaTable<List<DbReferencialConstraintInfo>> ReferentialContraints
        {
            get
            {
                if (referentialConstraints == null)
                {
                    ...
                    //referentialConstraints = Provider.GetReferentialContraints();
        ...
        public List<DbReferencialConstraintInfo> GetParentRelationsGeneric(string schemaName, string tableName)
        {
        ...
        */
        ...
        /// <returns></returns>
        public List<TableInfo> GetAllTables(string tableSchema = null, EnumTableType? tableType = null, bool useDatabase = false)
        {
        ...
        */
        ...
        {
            name = name.Replace(".", "_").Replace(" ", "_").Replace(",", "_").Replace(";", "_").Replace("[", "").Replace("]", "");
